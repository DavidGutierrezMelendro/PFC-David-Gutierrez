...
The appearence of new programs or protocols has lead to the web browsers to grow exponentially supporting new features, options, etcétera. that leads to them to grow in complexity and increasing the risk factors.
...
The main goal of the \textit{CloudTrust} project is to build a safety environment for a safer browsing of the net, making use of the current hosting/housing services that allows to perfectly manage the various vulnerability issues previously mentioned.
...
That is so, the safety of the client is the first compromise for \textit{CloudTrust}. To achieve this, various functionalities has been implemented, as device detection system, users identification or log events record.
